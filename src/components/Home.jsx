...
export default function Home() {
  ...
  return (
    <div className="w-full px-4 mt-8">
      ...
      <button onClick={handleFavouriteRecipes} className="bg-[rgba(114,63,95,1)] hover:bg-[rgba(114,63,95,0.9)] text-white px-5 py-3 rounded-full font-semibold text-base sm:text-lg shadow-md transition-all duration-200 mt-9">Favourites</button>
      </div>
