    ...
    return(
        <div className="flex flex-col items-center mt-8 w-full px-4">
            <form onSubmit={handleSubmit} className="flex justify-center w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl">
                <input className="flex-grow px-5 py-3 text-base sm:text-lg rounded-l-full border border-gray-300 caret-[rgba(114,63,95,1)] focus:outline-none bg-white" type="text" placeholder="Search for recipes..." value={search} onChange={(e) =>setSearch(e.target.value)} />
